  ...
  <?php switch($this->step) {
      ...
      <?php JHTML::_('script', 'createcvstep_one.js', 'components/com_jobboard/js/') ?>
          ...
          <div class="nopaddiv">
            ...
            <select id="available_yyyy" name="available_yyyy">
              <?php for($i = 0; $i < 3; $i++) : ?>
          ...
          <select id="job_type" name="job_type" class="clrright">
          ...
          <input class="clrright" type="checkbox" name="is_private" id="is_private" value="yes"<?php if($this->data['is_private'] == 1) echo 'checked="checked"' ?> />
          <div class="clear">&nbsp;</div>
  ...
  <?php case 2 : ?>
    ...
    <?php if(isset($this->edu_data[0]) && $this->section == 'education') : ?>
      <div id="edRow-1" class="qualrow first">
        ...
        <input type="text" size="40" name="qual_name[1]" value="<?php echo $this->edu_data[0]->qual_name ?>" class="clrright" />
        <label><?php echo JText::_('COM_JOBBOARD_SCHOOLNAME') ?></label>
        <input type="text" size="40" name="school_name[1]" value="<?php echo $this->edu_data[0]->school_name ?>" class="clrright"/>
        <label><?php echo JText::_('COM_JOBBOARD_TXTCOUNTRY') ?></label>
          ...
          <?php $ed_year = JHTML::_('date', $this->edu_data[0]->ed_year, $this->year_format)?>
    		<label><?php echo JText::_('COM_JOBBOARD_QUALYEAR') ?></label>
            <select name="ed_year[1]" class="infoRight clrright" >
        ...
        <?php if(count($this->edu_data) > 0) :?>
            ...
            <?php foreach($this->edu_data as $edu) : ?>
              <div id="edRow-<?php echo $ed_iterator ?>" class="qualrow">
                ...
                <label><?php echo JText::_('COM_JOBBOARD_QUALNAME') ?></label>
                <input type="text" size="40" name="qual_name[<?php echo $ed_iterator ?>]" value="<?php echo $edu->qual_name ?>" class="clrright" />
                <label><?php echo JText::_('COM_JOBBOARD_SCHOOLNAME') ?></label>
                <input type="text" size="40" name="school_name[<?php echo $ed_iterator ?>]" value="<?php echo $edu->school_name ?>" class="clrright" />
                <label><?php echo JText::_('COM_JOBBOARD_TXTCOUNTRY') ?></label>
                  ...
                  <?php $ed_year = JHTML::_('date', $edu->ed_year, $this->year_format)?>
            		<label><?php echo JText::_('COM_JOBBOARD_QUALYEAR') ?></label>
                    <select name="ed_year[<?php echo $ed_iterator ?>]" class="infoRight clrright" >
            		  <option value="-1">--</option>
                      <?php for($i = 0; $i < 41; $i++) : ?>
                        <option value="<?php echo $curyear - $i ?>" <?php if($ed_year == ($curyear - $i)) echo 'selected="selected"' ?> ><?php echo $curyear - $i ?></option>
                      <?php endfor; ?>
      ...
      <?php else : ?>
          <?php if($this->section == 'education' || $this->section <> 'employer') : ?>
            <div id="edRow-1" class="qualrow first">
              ...
              <label><?php echo JText::_('COM_JOBBOARD_QUALNAME') ?></label>
              <input type="text" size="40" name="qual_name[1]" value="" class="clrright" />
              <label><?php echo JText::_('COM_JOBBOARD_SCHOOLNAME') ?></label>
              <input type="text" size="40" name="school_name[1]" value="" class="clrright" />
              <label><?php echo JText::_('COM_JOBBOARD_TXTCOUNTRY') ?></label>
                  <select name="edu_country[1]">
                  	<?php foreach($this->countries as $country) : ?>
                      	<?php if($country->country_id == 266 ) :?>
      ...
      <?php if(isset($this->empl_data[0]) && $this->section == 'employer') : ?>
          <div id="employer-1" class="emplrow first">
              ...
              <?php $empl_start_year = ($this->empl_data[0]->start_yr <> 0 || $this->empl_data[0]->start_yr <> 9999)? JHTML::_('date', $this->empl_data[0]->start_yr, $this->year_format) : $this->empl_data[0]->start_yr ?>
              ...
              <?php $empl_end_year = ($this->empl_data[0]->end_yr <> 0 || $this->empl_data[0]->end_yr <> 9999)? JHTML::_('date', $this->empl_data[0]->end_yr, $this->year_format) : $this->empl_data[0]->end_yr ?>
              ...
              <div class="nopaddiv">
                ...
                <select name="endmon[1]">
                  <?php for($m = 1; $m < 13; $m++) : ?>
                    ...
                    <?php $month_string =  $curyear.'-'.$month_leading.'-'.$curday ?>
                    <option value="<?php echo $month_leading ?>" <?php if($empl_end_month == $month_leading) echo 'selected="selected"' ?>><?php echo JHTML::_('date', $month_string, $this->month_short_format) ?></option>
                  <?php endfor; ?>
                </select>
              ...
              <select name="startmon[1]" tabindex="40">
                <?php for($m = 1; $m < 13; $m++) : ?>
                    <?php $month_leading = sprintf("%02d",$m) ?>
                    <?php $month_string =  $curyear.'-'.$month_leading.'-'.$curday ?>
                  <option value="<?php echo $month_leading ?>" <?php if($empl_start_month == $month_leading) echo 'selected="selected"' ?>><?php echo JHTML::_('date', $month_string, $this->month_short_format) ?></option>
                <?php endfor; ?>
              </select>
            ...
            <?php foreach($this->empl_data as $empl) : ?>
                <div id="employer-<?php echo $empl_iterator ?>" class="emplrow">
                    ...
                    <input type="text" size="40" name="employer_city[<?php echo $empl_iterator ?>]" value="<?php echo $empl->location ?>" />
                     <?php $empl_start_year = ($empl->start_yr <> 0 || $empl->start_yr <> 9999)? JHTML::_('date', $empl->start_yr, $this->year_format) : $empl->start_yr ?>
                     <?php $empl_start_month = ($empl->start_yr <> 0 || $empl->start_yr <> 9999)? JHTML::_('date', $empl->start_yr, 'm') : $empl->start_yr ?>
                     <?php $empl_end_year = ($empl->end_yr <> 0 || $empl->end_yr <> 9999)? JHTML::_('date', $empl->end_yr, $this->year_format) : $empl->end_yr ?>
              ...
              <div class="nopaddiv">
                ...
                <select name="endmon[1]">
                  <?php for($m = 1; $m < 13; $m++) : ?>
                    <?php $month_leading = sprintf("%02d",$m) ?>
                    <?php $month_string =  $curyear.'-'.$month_leading.'-'.$curday ?>
                    <option value="<?php echo $month_leading ?>"><?php echo JHTML::_('date', $month_string, $this->month_short_format) ?></option>
                  <?php endfor; ?>
                </select>
                <label class="rightlabel"><?php echo JText::_('COM_JOBBOARD_END') ?></label>
                  <select name="startyear[1]" class="infoRight" tabindex="911">
             ...
             <?php else : ?>
                 ...
                 <?php foreach($this->skills as $skill) : ?>
                        <div id="skillrow-<?php echo $skill_iterator ?>" class="skillwrapper">
                           ...
                           <span class="skilllastuse">
                                 <?php $last_use = $skill->last_use <> '0000-00-00' ? JHTML::_('date', $skill->last_use, $this->year_format) : 0 ?>
                    ...
                    <?php if(intval($this->linkedin_arr['positions']['@attributes']['total']) == 1 )  : ?>
                        <div class="boxtitle">
                  	    ...
                  	    <p class="period">
                              ...
                              <?php if(isset($this->linkedin_arr['positions']['position']['end-date']) && is_array($this->linkedin_arr['positions']['position']['end-date'])) {$end_year_str = $this->linkedin_arr['positions']['position']['end-date']['year'].'-'.sprintf("%02d", $this->linkedin_arr['positions']['position']['end-date']['month']).'-27';$end_year = JHTML::_('date', $end_year_str, $this->month_long_format.' '.$this->year_format);} ?>
                  	          <abbr title="<?php echo $start_year ?>" class="dtstart"><?php echo JHTML::_('date', $start_year, $this->month_long_format.' '.$this->year_format) ?></abbr>&nbsp;&ndash;&nbsp;<abbr title="<?php echo $end_year_str ?>" class="dtstamp"><?php echo $end_year ?></abbr>
                  	    </p>
                        <input type="hidden" name="employer_name[<?php echo $job_ctr ?>]" value="<?php if(is_array($this->linkedin_arr['positions']['position']['company'])) echo $this->linkedin_arr['positions']['position']['company']['name'] ?>" />
                        <input type="hidden" name="job_title[<?php echo $job_ctr ?>]" value="<?php echo $this->linkedin_arr['positions']['position']['title'] ?>" />
                        <input type="hidden" name="empl_start[<?php echo $job_ctr ?>]" value="<?php echo $start_year ?>" />
                        <input type="hidden" name="empl_end[<?php echo $job_ctr ?>]" value="<?php echo $end_year_str ?>" />
                        <input type="hidden" name="empl_iscurr[<?php echo $job_ctr ?>]" value="<?php echo $this->linkedin_arr['positions']['position']['is-current'] == 'true'? 1 : 0 ?>" />
                    <?php else : ?>
                      <?php foreach($this->linkedin_arr['positions']['position'] as $pos) : ?>
                        <div class="boxtitle">
                  	    ...
                  	    <p class="period">
                              ...
                              <?php if(isset($pos['end-date']) && is_array($pos['end-date'])) {$end_year_str = $pos['end-date']['year'].'-'.sprintf("%02d", $pos['end-date']['month']).'-27';$end_year = JHTML::_('date', $end_year_str, $this->month_long_format.' '.$this->year_format);} ?>
                  	          <abbr title="<?php echo $start_year ?>" class="dtstart"><?php echo JHTML::_('date', $start_year, $this->month_long_format.' '.$this->year_format) ?></abbr>&nbsp;&ndash;&nbsp;<abbr title="<?php echo $end_year_str ?>" class="dtstamp"><?php echo $end_year ?></abbr>
                  	    </p>
                        <input type="hidden" name="employer_name[<?php echo $job_ctr ?>]" value="<?php if(is_array($pos['company'])) echo $pos['company']['name'] ?>" />
                        <input type="hidden" name="job_title[<?php echo $job_ctr ?>]" value="<?php echo $pos['title'] ?>" />
                        <input type="hidden" name="empl_start[<?php echo $job_ctr ?>]" value="<?php echo $start_year ?>" />
                        <input type="hidden" name="empl_end[<?php echo $job_ctr ?>]" value="<?php echo $end_year_str ?>" />
                        <input type="hidden" name="empl_iscurr[<?php echo $job_ctr ?>]" value="<?php echo $pos['is-current'] == 'true'? 1 : 0 ?>" />
                        <?php $job_ctr += 1; ?>
                     <?php endforeach ?>
                   <?php endif ?>
                 </div>
             ...
             <?php if(isset($this->linkedin_arr['educations']['education']) && intval($this->linkedin_arr['educations']['@attributes']['total']) > 0 )   :?>
                 <div class="cvblock">
                    ...
                    <?php if(intval($this->linkedin_arr['educations']['@attributes']['total']) == 1) :?>
                          ...
                          <input type="hidden" name="school_name[<?php echo $ed_ctr ?>]" value="<?php echo $ed['school-name'] ?>" />
                          <input type="hidden" name="qual_name[<?php echo $ed_ctr ?>]" value="<?php echo $ed['field-of-study'] ?>" />
                          <input type="hidden" name="school_start[<?php echo $ed_ctr ?>]" value="<?php echo $start_year ?>" />
                          <input type="hidden" name="school_end[<?php echo $ed_ctr ?>]" value="<?php echo $end_year ?>" />
                    <?php else : ?>
