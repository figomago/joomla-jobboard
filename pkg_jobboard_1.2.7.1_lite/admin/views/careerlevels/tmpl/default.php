...
<b><?php echo JText::_('COM_JOBBOARD_MANAGE_CAREER_LEVELS');?></b><p> </p>
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th><?php echo JHTML::_('grid.sort', JText::_('COM_JOBBOARD_DESCRIPTION'), 'description', $this->lists['orderDirection'], $this->lists['order']); ?></th>
