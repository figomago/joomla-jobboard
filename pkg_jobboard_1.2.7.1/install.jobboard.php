...
jimport('joomla.filesystem.folder');
   ...
   if($curr_version <> '1.2.5' && $curr_version <> '1.2.6' && $curr_version <> '1.2.7' && $curr_version <> '1.2.7.1'){
      ...
      // add new table - bookmarks
      $query = "CREATE TABLE IF NOT EXISTS `#__jobboard_bookmarks` (
      ...
      $db->setQuery($query);
      $db->Query();
      // add new table - cvprofiles
      $query = "CREATE TABLE IF NOT EXISTS `#__jobboard_cvprofiles` (
              `id` int(11) NOT NULL AUTO_INCREMENT,
      ...
      $db->setQuery($query);
      $db->Query();
      // add new table - file_tokens
      $query = "CREATE TABLE IF NOT EXISTS `#__jobboard_file_tokens` (
            `id` int(11) NOT NULL AUTO_INCREMENT,
      ...
      $db->setQuery($query);
      $db->Query();
      // add new table - invites
      $query = "CREATE TABLE IF NOT EXISTS `#__jobboard_invites` (
            `id` int(11) NOT NULL AUTO_INCREMENT,
      ...
      $db->setQuery($query);
      $db->Query();
      // add new table - past_edu
      $query = "CREATE TABLE IF NOT EXISTS `#__jobboard_past_edu` (
            `id` int(11) NOT NULL AUTO_INCREMENT,
            `cvprof_id` int(11) DEFAULT NULL,
            `user_id` int(11) DEFAULT '0',
      ...
      $db->setQuery($query);
      $db->Query();
      // add new table - past_employers
      $query = "CREATE TABLE IF NOT EXISTS `#__jobboard_past_employers` (
            `id` int(11) NOT NULL AUTO_INCREMENT,
            `cvprof_id` int(11) DEFAULT '0',
            `user_id` int(11) DEFAULT NULL,
      ...
      $db->setQuery($query);
      $db->Query();
      // add new table - questionnaires
      $query = "CREATE TABLE IF NOT EXISTS `#__jobboard_questionnaires` (
          `id` int(11) NOT NULL AUTO_INCREMENT,
      ...
      $db->Query();
      // add new table - users
      $query = "CREATE TABLE IF NOT EXISTS `#__jobboard_users` (
        `id` int(11) NOT NULL AUTO_INCREMENT,
      ...
      $db->setQuery($query);
      $db->Query();
      // add new table - userskills
      $query = "CREATE TABLE IF NOT EXISTS `#__jobboard_userskills` (
          `id` int(11) NOT NULL AUTO_INCREMENT,
      ...
      $db->setQuery($query);
      $db->Query();
      // add new table - usr_applications
      $query = "CREATE TABLE IF NOT EXISTS `#__jobboard_usr_applications` (
          `id` int(11) NOT NULL AUTO_INCREMENT,
          `user_id` int(11) DEFAULT NULL,
          `job_id` int(11) DEFAULT NULL,
          `cvprof_id` int(11) DEFAULT NULL,
      ...
      $db->setQuery($query);
      $db->Query();
      // add new table - usr_groups
      $query = "CREATE TABLE IF NOT EXISTS `#__jobboard_usr_groups` (
          `id` int(11) NOT NULL AUTO_INCREMENT,
      ...
      tblAddColumn('#__jobboard_unsolicited', 'filetype',' varchar(24) DEFAULT NULL AFTER `file_hash`');
	   ...
	   tblSetColumnValue('#__jobboard_config', 'release_ver', '1.2.7.1');
   }
  ...
  ******************************/
  ...
  <br />
  <p><?php echo JText::_('COM_JOBBOARD_WELCOME_MSG4'); ?></p>
  <a href="<?php echo JFilterOutput::AmpReplace('index.php?option=com_jobboard&view=users') ?>"><?php echo JText::_('COM_JOBBOARD_WELCOME_MSG5'); ?></a><br />
