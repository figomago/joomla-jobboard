...
<?php JHTML::_('behavior.modal', 'a.jobbrdmodal', $modal_params); ?>
<form action="index.php?option=com_jobboard&amp;view=applicants" method="post" name="adminForm" id="adminForm" >
		...
		for($i=0; $i<$n; $i++)
		{
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td align="center">
                  ...
                  <?php else: ?>
  					<a href="<?php echo JFilterOutput::ampReplace('index.php?option=com_jobboard&view=applicants&task=getucvfile&file='.$row->id.'&dmode=1&'.JUtility::getToken().'=1') ?>"><?php echo $row->title; ?> </a>
                  <?php endif; ?>
                </td>
				<td align="center">
	...
	<input type="hidden" name="vcontext" value="2" />
