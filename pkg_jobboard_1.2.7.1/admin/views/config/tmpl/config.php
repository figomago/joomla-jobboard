...
<div id="cfigoptions">
    <ul class="tabs">
    	...
    	<li class="users_tab">
    		<a href="<?php echo JRoute::_('index.php?option=com_jobboard&view=config&section=users') ?>">
    			<span class="jbcnav_text <?php if($this->section == 'users') echo 'active' ?>"><?php echo JText::_('COM_JOBBOARD_CFG_USERS') ?></span>
    		</a>
    	</li>
    	<li class="jobs_tab">
