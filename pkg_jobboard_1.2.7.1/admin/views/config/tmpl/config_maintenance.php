...
<div style="width:100%">
		...
		<table class="admintable config left">
			...
			<tr>
  		    ...
  		    <tr>
      			<td align="right" class="key">
      				<?php echo JText::_('COM_JOBBOARD_MAINT_TASKS_DB_BACKUP');?>
      			</td>
      			<td>
                   	<input type="radio" name="sched_backup_data" id="sched_backup_data0" value="0" <?php if($this->row->sched_backup_data == 0) echo 'checked="checked"'; ?> class="inputbox" />
                   	<label for="sched_backup_data0"><?php echo JText::_('JNO'); ?></label>
                   	<input type="radio" name="sched_backup_data" id="sched_backup_data1" value="1" <?php if($this->row->sched_backup_data == 1) echo 'checked="checked"'; ?> class="inputbox" />
                   	<label for="sched_backup_data1"><?php echo JText::_('JYES'); ?></label>
      			</td>
      		</tr>
		</table>
		<table class="admintable config right">
			...
			<tr>
				<td class="configsectionhead" colspan="2"><?php echo JText::_('COM_JOBBOARD_MAINT_DATA_IMPORT');?></td>
			</tr>
			<tr>
				<td colspan="2"><small><?php echo JText::_('COM_JOBBOARD_MAINT_DATA_IMPORT_INSTR');?></small></td>
			</tr>
			<tr>
				<td colspan="2"><input type="file" id="archive" name="archive" /><input type="submit" name="restore_zip" value="<?php echo JText::_('COM_JOBBOARD_MAINT_DATA_IMPORT_BTN');?>" /></td>
			</tr>
		</table>
</div>
