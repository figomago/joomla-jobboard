            ...
            <?php foreach ($this->cv_data->files as $file) : ?>
              ...
              <div class="filerow">
                 ...
                 <span class="filesrc <?php echo $filetype[1] ?>">
                    <a href="<?php echo JRoute::_('index.php?option=com_jobboard&view=admin&task=getucvfile&file='.$file->id.'&pid='.$this->cv_data->id.'&uid='.$this->cv_data->user_id.'&'.JUtility::getToken().'=1')?>"><?php echo $file->filename ?></a>
                 </span>
                 <br />
