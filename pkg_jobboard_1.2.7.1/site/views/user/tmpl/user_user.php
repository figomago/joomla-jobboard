        ...
        <?php foreach($this->user_applications as $appl) : ?>
          <div class="big_link first">
            <span class="jobcol">
              ...
              <br />
              <?php $job_title = (strlen($appl['job_title']) > 27) ? substr($appl['job_title'], 0, 25).'...' : $appl['job_title']; ?>
            ...
            <span class="cvcol">
              ...
              <br />
              <?php $cv_profile = (strlen($appl['profile_name']) > 25) ? substr($appl['profile_name'], 0, 25).'...' : $appl['profile_name']; ?>
