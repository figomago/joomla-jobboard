    ...
    <?php case 2 : //Profile picture ?>
        ...
        <div class="fieldrow">
          <div class="input avatar-settings">
            ...
            <div class="avwrapper">
                <?php if($this->is_profile_pic == true) : ?>
                    <img alt="<?php echo JText::_('COM_JOBBOARD_PROFPIC') ?>" id="profile-image" class="profile-image<?php if($this->is_ie) {if($this->is_early_ie) echo ' ieprof-img';} ?>" src="<?php echo $this->imgpath ?>" />
                <?php else : ?>
