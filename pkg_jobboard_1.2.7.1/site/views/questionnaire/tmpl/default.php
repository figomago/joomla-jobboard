...
?><?php JHTML::_('stylesheet', 'questionnaire_preview.css', 'components/com_jobboard/css/') ?>
                        ...
                        <?php if($field->type == 'date') : ?>
                            ...
                            <select <?php if($field->deflt->showMonth == 0) echo ' class="displnone"' ?> disabled="disabled" name="<?php echo $field->name ?>[month]">
                                ...
                                <?php for($i = 1; $i < 13; $i++) : ?>
                                  ...
                                  <option value="<?php echo $month_leading ?>" <?php if($curmonth_nr == $i) echo 'selected="selected"'; ?>><?php echo JHTML::_('date', $field->deflt->defaultMonth, $this->month_long_format) ?></option>
                                <?php endfor; ?>
                            </select>
